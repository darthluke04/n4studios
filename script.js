...
function startJS() {
	...
	$("#menu").html(`<div id="menuInner">
			...
			<div>
				<div class="material-symbols-outlined" title="Resume" onclick="window.location.href='https://drive.google.com/file/d/1bdWnFw_BRrErFQYfg06ERorbEMPGSzed/view?usp=sharing'">badge</div>
